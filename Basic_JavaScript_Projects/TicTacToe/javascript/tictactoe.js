...
function placeXOrO(squareNumber) {
    ...
    //The .some() method is is used to check each element of the selectSquare array
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/cat.jpg")';
        }
    ...
    function computersTurn() {
        ...
        while (!success) {
            //A random number betwen 0 and 8 is selected.
...
function checkWinConditions() {
    ...
    //This condition check for a tie. If none of the above conditions are met and
...
//This functoin makes our body element temporarily unclickable
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function clear() {
        ...
        c.clearRect(0, 0, 608, 608);
        //This line stops are animation loop
...
function resetGame() {
    //This for loop iterates thhrough each HTML square element.
    for (let i = 0; i < 9; i++) {
